      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
               <img src={contact?.logo} alt="logo" className='w-8 h-10'/>
              </div>
              <h2 className="text-xl font-bold text-white">{contact?.websiteTitle}</h2>
            </div>
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
             #306, 2nd Floor, NSIC-STP, B-24, Guindy Industrial Estate, Ekkatuthangal, Chennai-600032, India
            </p>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-white font-semibold mb-5 text-base uppercase tracking-wider">
              Navigation
            </h3>
            <ul className="space-y-3">
              <li>
                ...
                >
                  <ChevronRight size={14} className="mr-1 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" />
                  Home
                </Link>
              </li>
              <li>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {category.slice(0, 4).map((cat:any) => (
                <li key={cat._id}>
                  <Link 
