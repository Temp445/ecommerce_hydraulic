          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
           <div className="relative">
             <div className="sticky top-20">
              <h2 className="text-xl md:text-4xl  xl:text-5xl font-light text-gray-900 leading-tight mb-4 md:mb-8">
                {content?.WhyChooseUs?.title}
              </h2>
              <p className="text-sm md:text-lg text-gray-500 mb-5 md:mb-12">
                {content?.WhyChooseUs?.subTitle}
              </p>

              <div className="flex gap-10">
                <div>
                  <p className="text-xl md:text-3xl font-light text-gray-900">
            ...
            <div className=" space-y-5 md:space-y-12">
              {content?.WhyChooseUs?.features.map(
                (item: any, idx: number | null | undefined) => (
                  <div key={idx}>
                    <h3 className="text-xs md:text-sm font-medium text-gray-400 uppercase tracking-wider mb-3">
                      {item?.title}
                    </h3>
                    <h4 className="text-base md:text-xl text-gray-900 mb-2">
                      {item?.subTitle}
                    </h4>
              ...
              >
                <div className="absolute inset-0 bg-white group-hover:bg-opacity-10 transition-all duration-500 flex flex-col justify-center items-center p-8">
                  <div className="relative z-10 text-center">
                    <h3 className="text-xl md:text-3xl text-gray-900 tracking-tighter mb-2">
                      {item.value}
                    </h3>
