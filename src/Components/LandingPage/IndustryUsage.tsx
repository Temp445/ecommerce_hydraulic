  ...
  return (
    <section className=" py-5 md:py-20 bg-gray-100">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className=" text-xl md:text-4xl font-medium text-gray-900 mb-6  tracking-tight">
              ...
              >
                <div className="relative  w-full">
                  <img
                    ...
                    alt={app.title}
                    className="object-cover md:h-56 w-full group-hover:scale-110 transition-transform duration-700"
                  />
                </div>

                <div className="md:p-6 text-center">
                  <h3 className=" text-xs md:text-sm 2xl:text-xl md:font-semibold text-gray-900 mb-3 pt-1 transition-colors">
                    {app.title}
                  </h3>
                  <p className="text-gray-600 hidden md:block text-xs 2xl:text-sm leading-relaxed">
                    {app.description}
                  </p>
                </div>
              </div>
