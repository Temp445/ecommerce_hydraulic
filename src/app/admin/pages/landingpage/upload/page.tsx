    ...
    try {
      ...
      if (mode === "upload") {
        ...
        if (res.data.success) {
          ...
          setLandingData(res.data.data);
          setMode("view"); // switch to view after upload
        }
      } else if (mode === "edit") {
        ...
        >
              ...
              <div>
                ...
                {heroImagePreview ? (
                  <div className="relative w-fit bg-slate-100 rounded-lg overflow-hidden">
                    ...
                    <label className="absolute bottom-0 left-0 right-0 w-full h-full bg-opacity-50 text-white p-3 cursor-pointer hover:bg-opacity-70 transition flex items-center justify-center gap-2">
                      <input
                        type="file"
                        name="heroImage"
                        accept="image/*"
                  ...
                  <label className="block relative w-fit border-2 border-dashed border-slate-300 rounded-lg p-8 text-center hover:border-gray-900 hover:bg-slate-50 transition cursor-pointer">
                    ...
                    <p className="text-slate-600 font-semibold mb-1">Click to upload image</p>
                  </label>
                )}
              </div>
            </div>
              ...
              <div>
                ...
                {aboutImagePreview ? (
                  <div className="relative w-fit bg-slate-100 rounded-lg overflow-hidden">
                    ...
                    <label className="absolute bottom-0 left-0 right-0  bg-opacity-50 text-white  cursor-pointer hover:bg-opacity-70 transition flex items-center justify-center gap-2">
         ...
         {mode !== "view" && (
            <div className="flex justify-end pt-6 border-t border-slate-200">
              ...
              >
                {loading ? "Processing..." : <><Upload className="w-5 h-5" /> {mode === "upload" ? "Upload" : "Update"}</>}
              </button>
            </div>
          )}
        </form>
