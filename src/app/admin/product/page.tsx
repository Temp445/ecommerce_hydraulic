  ...
  return (
    <div className="p-6 pb-32 lg:pb-52">
      ...
      <div className="flex gap-4 mb-6 flex-wrap">
        <div
          className={`p-6 rounded-lg shadow-md flex flex-col justify-center h-28 cursor-pointer ${
            filter === "all" ? "bg-blue-200" : "bg-blue-50"
          }`}
        ...
        <div
          className={`p-6 rounded-lg shadow-md flex flex-col justify-center h-28 cursor-pointer ${
            filter === "outOfStock" ? "bg-red-200" : "bg-red-50"
          }`}
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-6">
          {[...Array(8)].map((_, idx) => (
            <div key={idx} className="bg-white border border-gray-400 rounded-xl shadow-sm p-4 animate-pulse">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {currentItems.map((product) => (
            ...
            >
              ...
              <h2 className="text-lg font-semibold text-slate-800 line-clamp-1 mb-1">{product.name}</h2>
