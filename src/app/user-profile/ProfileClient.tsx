      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="hidden w-14 h-14 rounded-lg bg-gradient-to-br from-teal-500 to-cyan-600 md:flex items-center justify-center shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-8">
              <div className="hidden md:flex items-center justify-between mb-6 pb-6 border-b border-slate-200">
                <div>
